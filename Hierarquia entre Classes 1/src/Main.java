...
//addAumento(double valor), ganhoAnual() e exibeDados() - imprime os
//valores do funcionário.
//        a) crie a classe Assistente, que também é um funcionário, e que possui um
//número de matrícula (faça os métodos GET e SET). Sobrescreva o
//método exibeDados().
//b) sabendo que os Assistentes Técnicos possuem um bônus salarial e que
//os Assistentes Administrativos possuem um turno (dia ou noite) e um
